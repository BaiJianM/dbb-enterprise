...
public interface DictionaryMapper extends BaseMapper<SysDictionary> {
     ...
     * @return: java.util.List<com.gientech.iot.user.biz.entity.SysDictionary>
     * @version: 1.0
     */
     ...
     * @return: com.baomidou.mybatisplus.core.metadata.IPage<com.gientech.iot.user.api.pojo.vo.DictTreeVO>
     * @version: 1.0
     */
     ...
     * @return: com.gientech.iot.user.api.pojo.vo.DictTreeVO
     * @version: 1.0
     */
