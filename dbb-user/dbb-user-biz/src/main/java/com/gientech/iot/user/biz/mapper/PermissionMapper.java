...
import com.gientech.iot.user.api.pojo.vo.PermissionTreeVO;
...
public interface PermissionMapper extends BaseMapper<SysPermission> {
     ...
     * @return: java.util.List<com.gientech.iot.user.entity.vo.PermissionTreeVO>
     * @version: 1.0
     */
     ...
     * @author: 白剑民
     * @date: 2022-10-31 13:44:50
     * @return: java.util.List<com.gientech.iot.user.biz.entity.SysPermission>
     * @version: 1.0
     */
