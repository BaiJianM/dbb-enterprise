...
public interface DepartmentService extends IService<SysDepartment> {
     ...
     * @return: top.dabaibai.user.entity.vo.DepartmentCreateResultVO
     * @version: 1.0
     */
     ...
     * @return: java.util.List<top.dabaibai.user.entity.vo.DepartmentSearchResultVO>
     * @version: 1.0
     */
     ...
     * @author: 白剑民
     * @date: 2022-10-21 16:01:15
     * @return: java.util.List<top.dabaibai.user.entity.vo.DepartmentTreeVO>
     * @version: 1.0
     */
