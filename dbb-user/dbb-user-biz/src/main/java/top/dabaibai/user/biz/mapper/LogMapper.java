...
public interface LogMapper extends BaseMapper<SysLog> {
     ...
     * @return: com.baomidou.mybatisplus.core.metadata.IPage<top.dabaibai.user.api.entity.vo.LogSearchResultVO>
     * @version: 1.0
     */
     ...
     * @return: java.util.List<top.dabaibai.user.biz.entity.SysLog>
     * @version: 1.0
     */
