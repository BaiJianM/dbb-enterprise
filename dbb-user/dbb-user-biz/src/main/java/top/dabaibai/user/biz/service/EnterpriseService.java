...
public interface EnterpriseService {
     ...
     * @return: top.dabaibai.user.entity.vo.EnterpriseRegisterResultVO
     * @version: 1.0
     */
     ...
     * @return: top.dabaibai.user.entity.Enterprise
     * @version: 1.0
     */
     ...
     * @return: top.dabaibai.web.commons.model.PageResultVO<
     ...
     * @return: top.dabaibai.user.entity.vo.EnterpriseCountVO
     * @version: 1.0
     */
