...
import top.dabaibai.user.api.pojo.vo.AuthCodeResultVO;
...
import top.dabaibai.web.configuration.authcode.AuthCodeTypeEnum;
import top.dabaibai.web.configuration.authcode.KaptchaProperties;
...
public class CaptchaController {
     ...
     * @return: top.dabaibai.core.global.response.DbbResponse<top.dabaibai.user.api.entity.vo.AuthCodeResultVO>
     * @version: 1.0
     */
    // TODO 不可无限调用，需后端配合前端增加调用三次后锁住1分钟的逻辑，后端锁住接口，前端增加解锁倒计时
    @Operation(summary = "获取图形验证码")
    @GetMapping
    public DbbResponse<AuthCodeResultVO> getCode() {
        ...
        try {
            ...
            throw new DbbException(CustomErrorCodeEnum.AUTH_CODE_ERROR);
        }
        result.setUuid(uuid);
