package top.dabaibai.web.configuration;
...
import top.dabaibai.web.configuration.handler.CommonExtHandler;
import top.dabaibai.web.configuration.interceptor.CustomHandlerInterceptor;
import top.dabaibai.web.configuration.repeat.RepeatRequestAspect;
...
public class DbbWebAutoConfiguration {
     ...
     * @return: top.dabaibai.core.annotations.repeat.RepeatRequestAspect
     * @version: 1.0
     */
    @Bean
