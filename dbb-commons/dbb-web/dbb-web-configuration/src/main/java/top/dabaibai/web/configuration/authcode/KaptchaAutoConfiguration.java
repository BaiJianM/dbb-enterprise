package top.dabaibai.web.configuration.authcode;
...
public class KaptchaAutoConfiguration {
    ...
    public DefaultKaptcha getKaptchaMath() {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "top.dabaibai.web.configuration.authcode.KaptchaTextCreator");
        // 验证码文本字符间距 默认为2
