package com.gientech.iot.redis;
...
import com.gientech.iot.redis.properties.CustomSpringCacheProperties;
import com.gientech.iot.redis.properties.RedisCustomProperties;
import com.gientech.iot.redis.listener.ListenerInitializer;
...
public class RedisAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "gientech.redis", name = "use-spring-cache", havingValue = "true")
