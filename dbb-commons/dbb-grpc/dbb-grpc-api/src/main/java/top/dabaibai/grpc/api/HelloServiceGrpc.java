...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<top.dabaibai.grpc.api.HelloServiceProto.HelloRequest,
      top.dabaibai.grpc.api.HelloServiceProto.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = top.dabaibai.grpc.api.HelloServiceProto.HelloRequest.class,
      responseType = top.dabaibai.grpc.api.HelloServiceProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<top.dabaibai.grpc.api.HelloServiceProto.HelloRequest,
      top.dabaibai.grpc.api.HelloServiceProto.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<top.dabaibai.grpc.api.HelloServiceProto.HelloRequest, top.dabaibai.grpc.api.HelloServiceProto.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<top.dabaibai.grpc.api.HelloServiceProto.HelloRequest, top.dabaibai.grpc.api.HelloServiceProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  top.dabaibai.grpc.api.HelloServiceProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  top.dabaibai.grpc.api.HelloServiceProto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(top.dabaibai.grpc.api.HelloServiceProto.HelloRequest request,
        io.grpc.stub.StreamObserver<top.dabaibai.grpc.api.HelloServiceProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
     ...
     * </pre>
     */
    public void sayHello(top.dabaibai.grpc.api.HelloServiceProto.HelloRequest request,
        io.grpc.stub.StreamObserver<top.dabaibai.grpc.api.HelloServiceProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
     ...
     * </pre>
     */
    public top.dabaibai.grpc.api.HelloServiceProto.HelloResponse sayHello(top.dabaibai.grpc.api.HelloServiceProto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<top.dabaibai.grpc.api.HelloServiceProto.HelloResponse> sayHello(
        top.dabaibai.grpc.api.HelloServiceProto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((top.dabaibai.grpc.api.HelloServiceProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<top.dabaibai.grpc.api.HelloServiceProto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              top.dabaibai.grpc.api.HelloServiceProto.HelloRequest,
              top.dabaibai.grpc.api.HelloServiceProto.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return top.dabaibai.grpc.api.HelloServiceProto.getDescriptor();
    }
