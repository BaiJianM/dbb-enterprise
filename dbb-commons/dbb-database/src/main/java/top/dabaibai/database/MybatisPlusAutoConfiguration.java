package top.dabaibai.database;

import com.baomidou.mybatisplus.annotation.DbType;
import com.baomidou.mybatisplus.extension.plugins.MybatisPlusInterceptor;
import com.baomidou.mybatisplus.extension.plugins.inner.OptimisticLockerInnerInterceptor;
import com.baomidou.mybatisplus.extension.plugins.inner.PaginationInnerInterceptor;
import top.dabaibai.database.properties.DynamicDataSourceConfiguration;
import top.dabaibai.database.datapermission.DataPermissionInterceptor;
import top.dabaibai.database.annotation.DataScope;
import top.dabaibai.database.datapermission.DataScopeAnnotationAdvisor;
import top.dabaibai.database.datapermission.DataScopeAnnotationIntercept;
import top.dabaibai.database.enums.DataSourceType;
import top.dabaibai.database.handler.FillMetaObjectHandler;
import top.dabaibai.database.interceptor.ForUpdateInterceptor;
import top.dabaibai.database.interceptor.ReadWriteInterceptor;
...
public class MybatisPlusAutoConfiguration {
     ...
     * @return: top.dabaibai.database.handler.FillMetaObjectHandler
     * @version: 1.0
     */
    @Bean
