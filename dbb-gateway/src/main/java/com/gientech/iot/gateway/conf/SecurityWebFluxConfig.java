...
import com.gientech.iot.gateway.filter.authentication.LoginAuthenticationWebFilter;
import com.gientech.iot.gateway.handler.*;
import com.gientech.iot.gateway.manager.authentication.account.AccountAuthenticationConverter;
import com.gientech.iot.gateway.manager.authentication.account.AccountReactiveAuthenticationManager;
import com.gientech.iot.gateway.manager.authentication.sms.SmsAuthenticationConverter;
import com.gientech.iot.gateway.manager.authentication.sms.SmsReactiveAuthenticationManager;
import com.gientech.iot.gateway.manager.authorization.CustomReactiveAuthorizationManager;
import feign.Feign;
...
//                .and().formLogin()
    ...
    public LoginAuthenticationWebFilter smsAuthenticationFilter() {
        ...
        filter.setRequiresAuthenticationMatcher(
                ServerWebExchangeMatchers.pathMatchers(HttpMethod.POST, "/gientech/sms/login"));
