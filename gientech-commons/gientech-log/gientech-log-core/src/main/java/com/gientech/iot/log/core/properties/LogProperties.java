package com.gientech.iot.log.core.properties;
 ...
 */
@Data
@ConfigurationProperties(prefix = "gientech.log-record")
public class LogProperties {
    ...
    /**
     * 在方法中主动抛出异常时的操作日志生成策略（默认不继续生成任何操作日志，注：未知异常（非GientechException）的情况下，不进行日志生成）
     */
