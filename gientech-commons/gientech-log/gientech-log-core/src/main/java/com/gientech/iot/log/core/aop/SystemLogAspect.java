package com.gientech.iot.log.core.aop;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.gientech.iot.core.pojo.vo.BaseUserInfoVO;
import com.gientech.iot.core.utils.IpUtils;
...
public class SystemLogAspect {
     ...
     * @version: 1.0
     */
    @Around("@annotation(com.gientech.iot.log.annotations.OperationLog) || @annotation(com.gientech.iot.log.annotations.OperationLogs)")
    public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
        ...
        // 原方法执行异常
            ...
            if (properties.isOnError() && throwable instanceof GientechException) {
                // 遍历执行方法后解析切面逻辑
                afterExec.forEach(annotation -> {
                    // 解析注解中定义的Spel表达式，返回LogDTO对象
                    LogDTO logDTO = resolveExpress(annotation, pjp);
