package com.gientech.iot.websocket.handler;
 ...
 */
public interface GientechWebSocketHandler extends WebSocketHandler {
    /**
     * 默认的redis广播消息监听频道
     */
    ...
    default void handleMessage(@NonNull WebSocketSession session,
        ...
        if (message instanceof TextMessage) {
            ...
            throw new GientechException(SystemErrorCode.UNSUPPORTED_WEBSOCKET_MESSAGE_TYPE);
        }
    }
