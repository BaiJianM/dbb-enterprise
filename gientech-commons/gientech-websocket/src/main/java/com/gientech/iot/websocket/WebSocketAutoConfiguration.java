package com.gientech.iot.websocket;

import com.gientech.iot.redis.utils.RedisUtils;
import com.gientech.iot.websocket.listener.DistributedWebSocketListener;
import com.gientech.iot.websocket.operation.DefaultWebSocketSender;
import com.gientech.iot.websocket.server.CustomWebSocketConfigurer;
...
public class WebSocketAutoConfiguration {
     ...
     * @return: com.gientech.iot.websocket.server.GientechWebSocketSender
     * @version: 1.0
     */
    @Bean
     ...
     * @return: com.gientech.iot.websocket.listener.DistributedWebSocketListener
     * @version: 1.0
     */
    @Bean
